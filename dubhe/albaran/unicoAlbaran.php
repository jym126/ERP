...
// create array
    ...
    echo json_encode("Albarán no encontrado.");
}
?>
<div>
    <script type="text/javascript">
        function setData(sel) {
            ...
            if (window.opener != null && !window.opener.closed) {
                ...
                window.opener.document.getElementById('codigoAlbBorrar').value = idAlb;
                window.opener.document.getElementById('codigo').value = codigoAlb;
