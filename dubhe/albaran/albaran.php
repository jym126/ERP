...
<script>
    function newCode() {
        ...
        document.getElementById('codigo').value = nuevoCodigoA;
    }
</script>

<!-- funcion recibir de presupuesto-->
<?php
include ('recibirDePresupuesto.php');
?>

<script>
    function recibir(){
        if ("<?php echo $codigoAlb;?>") {
            document.getElementById('importar').style.display = 'inline';
        }
    }
</script>

<div id="albaranes" class="tabcontent">
    <div id="main-nav"></div>
    ...
    <div class="juegoBotones">
        <button id="buscar" onclick="window.open('./buscarAlbaran.php',
    ...
    <div class="data">
        ...
        <input class="alb" id="email" type="text" size="25"><input class="alb" id="designation" type="hidden" size="25"><br><br>
    ...
    <div class="search-box">
        ...
        <form id="albaran" action="./guardarAlbaran.php" method="get">
        ...
        <form id="albaranBorrar" action="./borrarAlbaran.php" method="get">
        ...
        <script>
            function borrar(){
                var conf = confirm("¿Seguro que desea borrar el albarán ID "+ $('#codigoAlbBorrar').val()+"?");
                if (conf === true){
        ...
        <form id="factura" action="http://localhost:63342/ERP/RoundOutTabs2/factura/factura.php" method="get">
        ...
        <form id="albaranActualizar" action="./actualizarAlbaran.php" method="get">
            <input id="idAlb" name="idAlb" type="hidden">
            <input id="codigoAlb2" name="codigoAlb" type="hidden">
        ...
        <script>
            function actualizar(){
                var idFact = $('#codigoAlbBorrar').val();
                $('#idAlb').val(idFact);
                var codigo = $('#codigo').val();
                $('#codigoAlb2').val(codigo);
                var id = $('#id').val();
                ...
                var item10 = $('#codigoArt10').val();
                $('#item102').val(item10);
                document.getElementById("albaranActualizar").submit();
            }
        </script>
