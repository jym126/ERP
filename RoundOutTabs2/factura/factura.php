...
<head>
    ...
    <script>
        onload()
        {
            var codigo = <?php echo $codigo = $_GET['codigoFac'];?>;
...
<div id="clientes" class="tabcontent">
    ...
    <div class="juegoBotones">
        <button id="buscar" onclick="window.open('factura/buscarFactura.php',
        ...
        <button id="receive" onclick="window.open('factura/buscarAlbaranF.php',
        'Clientes', 'width=1200, height=600, top=320, left=300')"></button>
    ...
    <div class="data">
        ...
        <input class="fac" id="email" type="text" size="25"><br><br>
    ...
    <div class="search-box">
        ...
        <form id="factura" action="factura/guardarFactura.php" method="get">
